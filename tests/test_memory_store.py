...
class TestVectorEmbedding:
    ...
    def test_vector_embedding_creation(self):
        ...
        assert embedding.vector == [0.1, 0.2, 0.3]  # nosec: B101 - Test assertion
        assert embedding.embedding_type == "test"  # nosec: B101 - Test assertion
        assert embedding.dimensions == 3  # nosec: B101 - Test assertion
        assert (
            embedding.created_at == "2024-01-01T00:00:00"
    ...
    def test_vector_embedding_round_trip(self):
        ...
        assert original.vector == restored.vector  # nosec: B101 - Test assertion
        assert (
            original.embedding_type == restored.embedding_type
        )  # nosec: B101 - Test assertion
        assert (
            original.dimensions == restored.dimensions
        )  # nosec: B101 - Test assertion
        assert (
...
class TestMemoryEntry:
    ...
    def test_memory_entry_creation(self):
        ...
        assert entry.timestamp == "2024-01-01T00:00:00"  # nosec: B101 - Test assertion
        assert (
            entry.experiment_name == "test_experiment"
        )  # nosec: B101 - Test assertion
        assert entry.pattern_type == "success_pattern"  # nosec: B101 - Test assertion
        assert entry.content == "Test content"  # nosec: B101 - Test assertion
        assert entry.context == {"key": "value"}  # nosec: B101 - Test assertion
        assert entry.embedding is None  # nosec: B101 - Test assertion
    ...
    def test_memory_entry_auto_memory_id(self):
        ...
        assert entry.memory_id != ""  # nosec: B101 - Test assertion
        # Verify it's an MD5 hash (12 chars)
        assert len(entry.memory_id) == 12  # nosec: B101 - Test assertion
        assert all(
            c in "0123456789abcdef" for c in entry.memory_id
        )  # nosec: B101 - Test assertion
    ...
    def test_memory_entry_memory_id_deterministic(self):
        ...
        assert entry1.memory_id == entry2.memory_id  # nosec: B101 - Test assertion
    ...
    def test_memory_entry_asdict(self):
        ...
        assert (
            data["experiment_name"] == "test_experiment"
        )  # nosec: B101 - Test assertion
        assert data["pattern_type"] == "success_pattern"  # nosec: B101 - Test assertion
        assert data["content"] == "Test content"  # nosec: B101 - Test assertion
        assert data["context"] == {"key": "value"}  # nosec: B101 - Test assertion
...
class TestMemoryStoreInitialization:
    ...
    def test_memory_store_init(self, temp_storage_path):
        ...
        store = MemoryStore(storage_path=str(temp_storage_path))
        assert store.storage_path == temp_storage_path  # nosec: B101 - Test assertion
        assert store.memory == []  # nosec: B101 - Test assertion
        assert store._tfidf_dirty is True  # nosec: B101 - Test assertion
        assert store._idf == {}  # nosec: B101 - Test assertion
        assert store._doc_vectors == []  # nosec: B101 - Test assertion

    def test_memory_store_default_storage_path(self):
        """Test MemoryStore uses default storage path."""
        store = MemoryStore()
        assert (
            store.storage_path.name == "xpr_memory.json"
        )  # nosec: B101 - Test assertion
    ...
    def test_memory_store_load_existing(self, temp_storage_path):
        ...
        store = MemoryStore(storage_path=str(temp_storage_path))
        assert len(store.memory) == 1  # nosec: B101 - Test assertion
        assert (
            store.memory[0].experiment_name == "test_experiment"
        )  # nosec: B101 - Test assertion
    ...
    def test_memory_store_check_embedding_availability(self, temp_storage_path):
        ...
        with patch.dict(sys.modules, {"sentence_transformers": None}):
            store = MemoryStore(storage_path=str(temp_storage_path))
            assert (
                store.has_semantic_embeddings is False
            )  # nosec: B101 - Test assertion
...
class TestMemoryStoreAddMemory:
    ...
    def test_add_memory_basic(self, memory_store):
        ...
        assert len(memory_store.memory) == 1  # nosec: B101 - Test assertion
        assert (
            memory_store.memory[0].experiment_name == "test_exp"
        )  # nosec: B101 - Test assertion
        assert (
            memory_store.memory[0].pattern_type == "success_pattern"
        )  # nosec: B101 - Test assertion
        assert (
            memory_store.memory[0].content == "Test content"
        )  # nosec: B101 - Test assertion
    ...
    def test_add_memory_with_context(self, memory_store):
        ...
        assert memory_store.memory[0].context == {  # nosec: B101 - Test assertion
            "key1": "value1",
            "key2": "value2",
        }
    ...
    def test_add_memory_saves_to_file(self, memory_store, temp_storage_path):
        ...
        assert temp_storage_path.exists()  # nosec: B101 - Test assertion
        with open(temp_storage_path, "r") as f:
            data = json.load(f)
        assert len(data) == 1  # nosec: B101 - Test assertion
        assert data[0]["experiment_name"] == "test_exp"  # nosec: B101 - Test assertion
    ...
    def test_add_memory_multiple(self, memory_store):
        ...
        assert len(memory_store.memory) == 5  # nosec: B101 - Test assertion
    ...
    def test_add_memory_sets_tfidf_dirty(self, memory_store):
        ...
        assert memory_store._tfidf_dirty is True  # nosec: B101 - Test assertion
    ...
    def test_add_memory_generates_timestamp(self, memory_store):
        ...
        assert (
            memory_store.memory[0].timestamp is not None
        )  # nosec: B101 - Test assertion
        assert len(memory_store.memory[0].timestamp) > 0  # nosec: B101 - Test assertion
...
class TestMemoryStoreEmbeddings:
    ...
    def test_generate_hash_embedding(self, memory_store):
        ...
        assert isinstance(embedding, VectorEmbedding)  # nosec: B101 - Test assertion
        assert len(embedding.vector) == 128  # nosec: B101 - Test assertion
        assert embedding.embedding_type == "test"  # nosec: B101 - Test assertion
        assert embedding.dimensions == 128  # nosec: B101 - Test assertion
    ...
    def test_generate_hash_embedding_deterministic(self, memory_store):
        ...
        assert embedding1.vector == embedding2.vector  # nosec: B101 - Test assertion
    ...
    def test_generate_hash_embedding_normalized(self, memory_store):
        ...
        assert (
            abs(norm - 1.0) < 0.01
        )  # Should be close to 1.0  # nosec: B101 - Test assertion
    ...
    def test_add_memory_with_embedding(self, memory_store):
        ...
        assert entry.embedding is not None  # nosec: B101 - Test assertion
        assert len(entry.embedding.vector) == 128  # nosec: B101 - Test assertion
    ...
    def test_update_embeddings_for_all_partial(self, memory_store):
        ...
        assert (
            memory_store.memory[0].embedding is not None
        )  # nosec: B101 - Test assertion
        assert (
            memory_store.memory[1].embedding is not None
        )  # nosec: B101 - Test assertion
...
class TestMemoryStoreSimilarity:
    ...
    def test_cosine_similarity_dense_identical(self, memory_store):
        ...
        assert abs(result - 1.0) < 0.0001  # nosec: B101 - Test assertion
    ...
    def test_cosine_similarity_dense_orthogonal(self, memory_store):
        ...
        assert abs(result - 0.0) < 0.0001  # nosec: B101 - Test assertion
    ...
    def test_euclidean_distance(self, memory_store):
        ...
        assert abs(result - 5.0) < 0.0001  # nosec: B101 - Test assertion
...
class TestMemoryStoreSearch:
    ...
    def test_vector_semantic_search_with_results(self, memory_store):
        ...
        assert isinstance(results, list)  # nosec: B101 - Test assertion
        # Should return up to top_k results
        assert len(results) <= 2  # nosec: B101 - Test assertion
    ...
    def test_get_related_memories(self, memory_store):
        ...
        assert isinstance(related, list)  # nosec: B101 - Test assertion
        # Should not include the reference entry itself
        for entry, score in related:
            assert (
                entry.memory_id != ref_entry.memory_id
            )  # nosec: B101 - Test assertion
...
class TestMemoryStoreTFIDF:
    ...
    def test_tokenize(self, memory_store):
        ...
        assert "hello" in tokens  # nosec: B101 - Test assertion
        assert "world" in tokens  # nosec: B101 - Test assertion
        assert "test_123" in tokens  # nosec: B101 - Test assertion
    ...
    def test_tokenize_punctuation(self, memory_store):
        ...
        assert "hello" in tokens  # nosec: B101 - Test assertion
        assert "world" in tokens  # nosec: B101 - Test assertion
        assert "test" in tokens  # nosec: B101 - Test assertion
        # Punctuation should be removed
        assert "," not in tokens  # nosec: B101 - Test assertion
        assert "!" not in tokens  # nosec: B101 - Test assertion
    ...
    def test_build_tfidf_index_empty(self, memory_store):
        ...
        assert memory_store._idf == {}  # nosec: B101 - Test assertion
        assert memory_store._doc_vectors == []  # nosec: B101 - Test assertion
        assert memory_store._tfidf_dirty is False  # nosec: B101 - Test assertion
    ...
    def test_build_tfidf_index(self, memory_store):
        ...
        memory_store._build_tfidf_index()
        assert len(memory_store._idf) > 0  # nosec: B101 - Test assertion
        assert len(memory_store._doc_vectors) == 2  # nosec: B101 - Test assertion
        assert memory_store._tfidf_dirty is False  # nosec: B101 - Test assertion
    ...
    def test_retrieve_memories(self, memory_store):
        ...
        assert len(results) > 0  # nosec: B101 - Test assertion
        assert (
            results[0].experiment_name == "neural_network_exp"
        )  # nosec: B101 - Test assertion
    ...
    def test_retrieve_memories_limit(self, memory_store):
        ...
        assert len(results) <= 3  # nosec: B101 - Test assertion
    ...
    def test_retrieve_memories_by_filter(self, memory_store):
        ...
        assert results[0].content == "content 2"  # nosec: B101 - Test assertion
...
class TestUpdateMemoryFromReport:
    ...
    def test_update_memory_from_report_with_root_causes(self, memory_store):
        ...
        assert len(failure_memories) == 2  # nosec: B101 - Test assertion
    ...
    def test_update_memory_from_report_with_fixes(self, memory_store):
        ...
        assert len(strategy_memories) == 2  # nosec: B101 - Test assertion
    ...
    def test_update_memory_from_report_with_success(self, memory_store):
        ...
        assert len(success_memories) == 1  # nosec: B101 - Test assertion
    ...
    def test_update_memory_from_report_no_success(self, memory_store):
        ...
        assert len(success_memories) == 0  # nosec: B101 - Test assertion
    ...
    def test_update_memory_from_report_with_llm(self, memory_store):
        ...
        assert len(success_memories) == 1  # nosec: B101 - Test assertion
        assert (
            success_memories[0].content == "LLM extracted lesson"
        )  # nosec: B101 - Test assertion
    ...
    def test_update_memory_from_report_llm_failure_fallback(self, memory_store):
        ...
        assert len(failure_memories) == 1  # nosec: B101 - Test assertion
        assert failure_memories[0].content == "cause 1"  # nosec: B101 - Test assertion
    ...
    def test_update_memory_from_report_empty_report(self, memory_store):
        ...
        assert len(memory_store.memory) == 0  # nosec: B101 - Test assertion
...
class TestMemoryStoreEdgeCases:
    ...
    def test_add_memory_with_special_characters(self, memory_store):
        ...
        assert len(memory_store.memory) == 1  # nosec: B101 - Test assertion
        assert "中文" in memory_store.memory[0].content  # nosec: B101 - Test assertion
    ...
    def test_add_memory_very_long_content(self, memory_store):
        ...
        assert (
            memory_store.memory[0].content == long_content
        )  # nosec: B101 - Test assertion
    ...
    def test_euclidean_distance_single_element(self, memory_store):
        ...
        vec2 = [0.0]
        result = memory_store._euclidean_distance(vec1, vec2)
        assert abs(result - 3.0) < 0.0001  # nosec: B101 - Test assertion
...
class TestMemoryStoreIntegration:
    ...
    def test_full_workflow(self, memory_store):
        ...
        assert len(filtered) > 0  # nosec: B101 - Test assertion
    ...
    def test_save_and_load_persistence(self, temp_storage_path):
        ...
        assert len(store2.memory) == 1  # nosec: B101 - Test assertion
        assert (
            store2.memory[0].content == "Persistent content"
        )  # nosec: B101 - Test assertion
    ...
    def test_concurrent_add_memory(self, memory_store):
        ...
        assert len(memory_store.memory) == 30  # nosec: B101 - Test assertion
    ...
    def test_tfidf_rebuild_after_add(self, memory_store):
        ...
        memory_store._build_tfidf_index()
        assert memory_store._idf != initial_idf  # nosec: B101 - Test assertion
