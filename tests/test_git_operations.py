...
class TestGitOperation:
    ...
    def test_default_values(self):
        ...
        assert op.operation_type == "stage"  # nosec: B101 - Test assertion
        assert op.files == ["test.py"]  # nosec: B101 - Test assertion
        assert op.commit_hash is None  # nosec: B101 - Test assertion
        assert op.branch_name is None  # nosec: B101 - Test assertion
        assert op.timestamp == 0.0  # nosec: B101 - Test assertion
    ...
    def test_custom_values(self):
        ...
        assert op.operation_type == "commit"  # nosec: B101 - Test assertion
        assert op.files == ["file1.py", "file2.py"]  # nosec: B101 - Test assertion
        assert op.commit_hash == "abc123"  # nosec: B101 - Test assertion
        assert op.branch_name == "main"  # nosec: B101 - Test assertion
        assert op.timestamp == 1234567890.0  # nosec: B101 - Test assertion
...
class TestGitStatus:
    ...
    def test_default_values(self):
        ...
        status = GitStatus()
        assert status.branch == ""  # nosec: B101 - Test assertion
        assert status.modified_files == []  # nosec: B101 - Test assertion
        assert status.untracked_files == []  # nosec: B101 - Test assertion
        assert status.staged_files == []  # nosec: B101 - Test assertion
        assert status.is_clean is True  # nosec: B101 - Test assertion
    ...
    def test_custom_values(self):
        ...
        assert status.branch == "main"  # nosec: B101 - Test assertion
        assert status.modified_files == ["file1.py"]  # nosec: B101 - Test assertion
        assert status.untracked_files == ["file2.py"]  # nosec: B101 - Test assertion
        assert status.staged_files == ["file3.py"]  # nosec: B101 - Test assertion
        assert status.is_clean is False  # nosec: B101 - Test assertion
...
class TestRepositoryInfo:
    ...
    def test_default_values(self):
        ...
        info = RepositoryInfo()
        assert info.root_path == Path()  # nosec: B101 - Test assertion
        assert info.current_branch == ""  # nosec: B101 - Test assertion
        assert info.remote_url is None  # nosec: B101 - Test assertion
        assert info.last_commit_hash is None  # nosec: B101 - Test assertion
    ...
    def test_custom_values(self):
        ...
        assert info.root_path == Path("/repo")  # nosec: B101 - Test assertion
        assert info.current_branch == "main"  # nosec: B101 - Test assertion
        assert (
            info.remote_url == "https://github.com/user/repo.git"
        )  # nosec: B101 - Test assertion
        assert info.last_commit_hash == "abc123"  # nosec: B101 - Test assertion
...
class TestGitError:
    ...
    def test_error_creation(self):
        ...
        assert str(error) == "Test error"  # nosec: B101 - Test assertion

    def test_error_with_command(self):
        """Test GitError with command info."""
        error = GitError("Command failed", command="git status")
        assert "Command failed" in str(error)  # nosec: B101 - Test assertion
...
class TestIsGitRepository:
    ...
    def test_valid_repository(self, tmp_path):
        ...
        git_dir.mkdir()
        assert is_git_repository(tmp_path) is True  # nosec: B101 - Test assertion

    def test_invalid_repository(self, tmp_path):
        """Test with non-git directory."""
        assert is_git_repository(tmp_path) is False  # nosec: B101 - Test assertion

    def test_nonexistent_path(self):
        """Test with nonexistent path."""
        assert (
            is_git_repository(Path("/nonexistent/path")) is False
        )  # nosec: B101 - Test assertion
...
class TestGetRepositoryInfo:
    ...
    @patch("utils.git_operations.subprocess.run")
    def test_get_info_success(self, mock_run, tmp_path):
        ...
        with patch("utils.git_operations.is_git_repository", return_value=True):
            info = get_repository_info(tmp_path)
            assert isinstance(info, RepositoryInfo)  # nosec: B101 - Test assertion
...
class TestGetCurrentBranch:
    ...
    def test_get_branch_success(self, mock_run):
        ...
        assert branch == "main"  # nosec: B101 - Test assertion
    ...
    def test_get_branch_failure(self, mock_run):
        ...
        branch = get_current_branch()
        assert branch == ""  # nosec: B101 - Test assertion
...
class TestGitOperations:
    ...
    def test_init_default(self):
        ...
        assert ops.repo_path.is_absolute()  # nosec: B101 - Test assertion
        assert ops.repo_path.name == "apgi-research"  # nosec: B101 - Test assertion

    def test_init_custom_path(self, tmp_path):
        """Test initialization with custom path."""
        ops = GitOperations(tmp_path)
        assert ops.repo_path == tmp_path  # nosec: B101 - Test assertion
    ...
    def test_status(self, mock_run, tmp_path):
        ...
        ops = GitOperations(tmp_path)
        status = ops.status()
        assert isinstance(status, GitStatus)  # nosec: B101 - Test assertion
        assert status.branch == "main"  # nosec: B101 - Test assertion
    ...
    def test_get_log(self, mock_run, tmp_path):
        ...
        assert len(log) == 2  # nosec: B101 - Test assertion
    ...
    def test_get_remotes(self, mock_run, tmp_path):
        ...
        assert "origin" in remotes  # nosec: B101 - Test assertion
