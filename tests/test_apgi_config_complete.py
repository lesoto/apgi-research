...
class TestModuleLevelFunctions:
    ...
    def test_get_config_function(self):
        ...
        config1 = get_config()
        config2 = get_config()
        assert config1 is config2  # Singleton pattern  # nosec: B101 - Test assertion
...
class TestConfigManagerPrivateMethods:
    ...
    def test_load_from_file_method(self):
        ...
        try:
            ...
            assert config.get("key") == "value"  # nosec: B101 - Test assertion
        finally:
    ...
    def test_find_config_file_method(self):
        ...
        with patch("pathlib.Path.exists") as mock_exists:
            ...
            with patch.dict(os.environ, {"APGI_CONFIG_FILE": "/custom/path"}):
                ...
                assert str(result) == "/custom/path"  # nosec: B101 - Test assertion
    ...
    def test_load_from_environment_method(self):
        ...
        with patch.dict(os.environ, env_vars, clear=True):
            ...
            assert config.get("number") == 42  # nosec: B101 - Test assertion
    ...
    def test_get_all_sources_method(self):
        ...
        assert sources == expected  # nosec: B101 - Test assertion
