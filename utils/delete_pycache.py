...
DEFAULT_EXTRA_FILE_PATTERNS = [
    ...
    "*.pyc.*",  # Variant pyc files
    "*.pyo.*",  # Variant pyo files
    "*.pyd.*",  # Variant pyd files
    ".pytest_cache.*",  # pytest cache files
    ".mypy_cache.*",  # mypy cache files
    ".coverage.*",  # Coverage cache files (additional variants)
    "*.coverage.*",  # Coverage files with prefixes
    "coverage.*",  # Coverage files without dot prefix
    # Python interpreter and environment files
    "*.pyp",  # Python package files
    "*.pyi",  # Python stub files (optional - may want to keep)
    ".python-version",  # Python version files
    "Pipfile.lock",  # Pip lock files (optional)
    "poetry.lock",  # Poetry lock files (optional)
    "*.egg-info",  # Python package metadata (already in patterns but ensuring visibility)
    # Additional editor/backup patterns
    "*.theirs",
    "*.r*",
    "*~",
    "*.swp",
